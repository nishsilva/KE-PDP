...
GPH_850_NP_NA = reshape(GPH_850_NP_NA, 701* 361, 7, 38);
GPH_850_NP_NA = GPH_850_NP_NA(:, 1:6, :);
...
colormap(cmap_mod)
caxis([-12 12]); % set the limits of the colorbar
...
limit = 12;
caxis([-limit limit]);
h = colorbar('Location', 'eastoutside', 'XTick', -12: 2 :12);
...
print('Nish_030323_KE_PDP_MS_Fig_4_PS_revised','-dpng', '-r500');
